...
import 'package:mgreen_app/view/screen/market/market_detail_screen.dart';
                ...
                Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context , int index){
                        return InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>const VoucherMarketDetail()));
                          },
                          child: Container(
