...
class HomeScreen extends StatefulWidget {
  const HomeScreen({super.key,required this.userPhoneNumber});
              ...
              child: Row(
                ...
                children: List.generate(3, (index) {
                  return index == 2 ? InkWell(
                    onTap: (){
                      connectionStandard.navigateToMiniApp(context, WeatherApp(navigateBackBtn: IconButton(icon: const Icon(Icons.chevron_left,size: 20,),onPressed: (){Navigator.pop(context);},),));
                    },
                    child: Container(
